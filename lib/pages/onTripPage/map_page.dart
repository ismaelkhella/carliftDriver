...
import 'package:tagxisuperdriver/functions/geohash.dart';
...
import 'package:tagxisuperdriver/pages/chatPage/chat_page.dart';
...
import 'package:tagxisuperdriver/pages/navDrawer/nav_drawer.dart';
            ...
            builder: (context, value, child) {
              ...
              if (driverReq.isNotEmpty) {
                ...
                element.markerId != const MarkerId('1'))
                  ...
                  if (userReject == true) {
                    reqCancel();
                    audioPlayers.play(AssetSource(audioClientCancel));
                  }
                  _dropMarkerDone = false;
                  _pickAnimateDone = false;
                }
                            ...
                            if (element['l'] != null &&
                              ...
                              if (userDetails['role'] == 'owner') {
                                if (userDetails['role'] == 'owner' &&
                                  ...
                                  if ((element['is_active'] != 0 && myMarkers
                                      .lastWhere((e) =>
                                  ...
                                  if ((element['is_active'] != 1 && myMarkers
                                      .lastWhere((e) =>
                                      e.markerId.toString().contains(
                                          'car${element['id']}'))
                                      .icon == onlineicon) ||
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        OwnerCarImagecontainer(
                                                          color: Colors.green,
                                                          imgurl: (transportType ==
                                                              'taxi' ||
                                                              transportType ==
                                                                  'both')
                                                              ? 'assets/images/available.png'
                                                              : 'assets/images/available_delivery.png',
                                                        ...
                                                        OwnerCarImagecontainer(
                                                          ...
                                                          imgurl: (transportType ==
                                                              ...
                                                              : 'assets/images/onboard_delivery.png',
                                                        ...
                                                        OwnerCarImagecontainer(
                                                          ...
                                                          imgurl: (transportType ==
                                                              ...
                                                              : 'assets/images/offlinecar_delivery.png',
                                                      ...
                                                      decoration: BoxDecoration(
                                                          image: DecorationImage(
                                                              image: (transportType ==
                                                                  ...
                                                                  : const AssetImage(
                                                                  'assets/images/bluecar_delivery.png'),
                                                              fit: BoxFit
                                                                  .contain),
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                              ...
                                                              color: onlineOfflineText),
                                                          child: Image.asset(
                                                              'assets/images/offline.png',color:Colors.red),
                                                        )
                                                      ],
                                                    )
                                                        : Row(
                                                    ...
                                                    children: [
                                                      (driverReq['is_later'] ==
                                                        ...
                                                        width: media.width *
                                                            0.9,
                                                        child: Text(
                                                          languages[choosenLanguage]['text_rideLaterTime'] +
                                                              " " +
                                                              driverReq['cv_trip_start_time'],
                                                          style: GoogleFonts
                                                              .roboto(
                                                              fontSize: media
                                                                  .width *
                                                        ...
                                                        width: media.width *
                                                            0.9,
                                                        child: Text(
                                                          languages[choosenLanguage]['text_rental_ride'] +
                                                              ' - ' +
                                                              ...
                                                              Container(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  ...
                                                                                  (driverReq['show_request_eta_amount'] ==
                                                                                    ...
                                                                                    child: FittedBox(
                                                                                      child: Text(
                                                                                        driverReq['requested_currency_symbol'] +
                                                                                            driverReq['request_eta_amount']
                                                                                                .toStringAsFixed(
                                                                                                2),
                                                                                        style: GoogleFonts
                                                                    ...
                                                                    (driverReq['pickup_poc_instruction'] !=
                                                                        null)
                                                                        ? Container(
                                                                        padding: EdgeInsets
                                                                            .only(
                                                                        ...
                                                                        child: SizedBox(
                                                                          ...
                                                                          child: Row(
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                languages[choosenLanguage]['text_instructions'] +
                                                                                    ' : ' +
                                                                                    driverReq['pickup_poc_instruction'],
                                                                                style: GoogleFonts
                                                                                    .roboto(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        driverReq['userDetail']['data']['rating']
                                                                            .toString(),
                                                                        style: GoogleFonts
                                                                            .roboto(
                                                                            fontSize: media
                                                              ...
                                                              children: [
                                                                ...
                                                                (driverReq['is_rental'] !=
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    : Container(),
                                                                (driverReq['drop_poc_instruction'] !=
                                                                    null)
                                                                    ? Container(
                                                                    padding: EdgeInsets
                                                                        .only(
                                                            ...
                                                            if (driverReq['is_driver_arrived'] ==
                                                              ...
                                                              if (driverReq['enable_shipment_unload_feature']
                                                                ...
                                                                Navigator.push(
                                                                    ...
                                                                    MaterialPageRoute(
                                                                        builder: (
                                                                            context) => const DigitalSignature()));
                                                              } else {
                                                                var val = await endTrip();
                                                                if (val ==
                                                                    'logout') {
                                                ...
                                                Button(
                                                    onTap: () async {
                                                      if (platform ==
                                                        ...
                                                        await http.get(
                                                            Uri.parse(
                                                                'http://itunes.apple.com/lookup?bundleId=${package
                                                                    .packageName}'));
                                                        if (response
                                                            .statusCode ==
                                                            200) {
